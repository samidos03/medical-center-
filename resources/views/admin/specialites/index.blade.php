...
<div class="card">
    <div class="card-header">
        <h2>{{ $Specialities->total() }} Specialities</h2>
        <a href="{{ route('admin.Specialities.create') }}" class="btn-primary">
            ...
            <tr>
                ...
                <td>
                    <div style="display:flex;justify-content:flex-end;gap:6px">
                        <a href="{{ route('admin.Specialities.edit', $s) }}" class="btn-secondary" style="padding:7px 12px">
                            <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                        </a>
                        <form action="{{ route('admin.Specialities.destroy', $s) }}" method="POST" onsubmit="return confirm('Supprimer ?')">
                            @csrf @method('DELETE')
    ...
    <div class="pagination-wrap">{{ $Specialities->links() }}</div>
    @endif
</div>
@endsection
