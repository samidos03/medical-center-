...
<head>
    ...
    <title>@yield('title', 'Admin') - Bahjawa Medical Center</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.Specialities.index') }}" class="nav-item {{ request()->routeIs('admin.Specialities.*') ? 'active' : '' }}">
...
<div class="main">
    <div class="topbar">
        <div class="topbar-left">
            ...
            <p>@yield('subtitle', 'Bahjawa Medical Center')</p>
        </div>
