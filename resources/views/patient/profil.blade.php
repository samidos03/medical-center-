...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .content{padding:24px 28px;flex:1;max-width:750px}
        ...
        .hero-avatar{width:60px;height:60px;background:rgba(255,255,255,.2);border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:20px;color:white;border:2px solid rgba(255,255,255,.3)}
        ...
        <form method="POST" action="{{ route('patient.profil.update') }}">
            ...
            <div class="form-card">
                ...
                <div class="grid2">
                    <div class="field">
                        <label>Phone</label>
                        <input type="text" name="phone" value="{{ old('phone',$user->phone) }}" placeholder="0600000000">
                    </div>
                    <div class="field">
                        <label>Address</label>
                        <input type="text" name="address" value="{{ old('address',$user->address) }}" placeholder="Marrakech">
                    </div>
                </div>
            </div>
