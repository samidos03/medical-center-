...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .Prescription-box{background:#f0fdf4;border-top:1px solid #bbf7d0;padding:16px 20px;display:flex;justify-content:space-between;align-items:center}
        .btn-pdf{display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,#059669,#065f46);color:white;border:none;border-radius:10px;padding:10px 20px;font-size:13px;font-weight:600;cursor:pointer;text-decoration:none;transition:opacity .2s}
...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <p>Your Consultations and prescriptions</p>
        </div>
    ...
    <div class="content">
        ...
        <div class="stats-row">
            <div class="stat">
                <div class="stat-num" style="color:#b45309">{{ $rdvs->count() }}</div>
                <div class="stat-lbl">Total Records</div>
            </div>
            <div class="stat">
                <div class="stat-num" style="color:#16a34a">{{ $rdvs->where('statut','Confirmed')->count() }}</div>
                <div class="stat-lbl">Confirmed</div>
            </div>
            <div class="stat">
                <div class="stat-num" style="color:#7c3aed">{{ $rdvs->filter(fn($r) => $r->consultation)->count() }}</div>
                <div class="stat-lbl">Consultations</div>
            </div>
            <div class="stat">
                <div class="stat-num" style="color:#059669">{{ $rdvs->filter(fn($r) => $r->consultation?->Prescription)->count() }}</div>
                    ...
                    <div class="Prescription-box">
                        <div>
                            ...
                            <div style="font-size:12px;color:#64748b;margin-top:2px">
                                Issued on {{ \Carbon\Carbon::parse($rdv->consultation->Prescription->date_creation)->format('d/m/Y') }}
                            </div>
                        </div>
