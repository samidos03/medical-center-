...
<head>
    ...
    <title>Appointments - Bahjawa Medical</title>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn-confirm{display:inline-flex;align-items:center;gap:4px;background:#f0fdf4;color:#16a34a;border:1px solid #bbf7d0;border-radius:8px;padding:6px 12px;font-size:12px;font-weight:600;cursor:pointer}
        .btn-cancel{display:inline-flex;align-items:center;gap:4px;background:#fef2f2;color:#dc2626;border:1px solid #fecaca;border-radius:8px;padding:6px 12px;font-size:12px;font-weight:600;cursor:pointer}
...
<div class="main">
    <div class="topbar">
        <div><h1>Appointments</h1><p>Manage and confirm appointments</p></div>
        ...
        <div class="card">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-weight:600">{{ $rdv->patient->user->name??'-' }}</td>
                    ...
                    @empty
                    <tr><td colspan="7" style="text-align:center;color:#94a3b8;padding:32px">No appointments found.</td></tr>
                    @endforelse
                </tbody>
            </table>
