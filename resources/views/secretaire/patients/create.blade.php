            ...
            <div class="form-card">
                ...
                <div class="grid2">
                    <div class="field">
                        ...
                        <input type="text" name="name" value="{{ old('name', isset($patient) ? $patient->user->name : '') }}" required placeholder="Mohamed Alami">
                        @error('name')<p class="err">{{ $message }}</p>@enderror
                    </div>
                    <div class="field">
                        <label>Email</label>
                        <input type="email" name="email" value="{{ old('email', isset($patient) ? $patient->user->email : '') }}" required>
                ...
                <div class="field">
                    <label>Phone</label>
                    <input type="text" name="phone" value="{{ old('phone', isset($patient) ? $patient->user->phone : '') }}" placeholder="0600000000">
                </div>
            </div>
            <div class="form-card">
                ...
                <div class="grid3">
                    <div class="field">
                        ...
                        <input type="date" name="birth_date" value="{{ old('birth_date', isset($patient) && $patient->birth_date ? $patient->birth_date->format('Y-m-d') : '') }}">
                    </div>
                    <div class="field">
                        <label>Gender</label>
                        <select name="gender">
                            <option value="">—</option>
                            <option value="M" @selected(old('gender', isset($patient) ? $patient->gender : '')==='M')>Male</option>
                            <option value="F" @selected(old('gender', isset($patient) ? $patient->gender : '')==='F')>Female</option>
                        </select>
                    </div>
                    <div class="field">
                        <label>Blood Type</label>
                        <input type="text" name="blood_type" value="{{ old('blood_type', isset($patient) ? $patient->blood_type : '') }}" placeholder="A+, O-...">
                    </div>
                </div>
                <div class="grid2">
                    <div class="field">
                        <label>Allergies</label>
                        <input type="text" name="allergies" value="{{ old('allergies', isset($patient) ? $patient->allergies : '') }}" placeholder="None">
                    </div>
                    <div class="field">
                        <label>Medical Conditions</label>
                        <input type="text" name="medical_conditions" value="{{ old('medical_conditions', isset($patient) ? $patient->medical_conditions : '') }}" placeholder="None">
                    </div>
                </div>
                <div class="grid2">
                    <div class="field">
                        <label>Emergency Contact</label>
                        <input type="text" name="emergency_contact" value="{{ old('emergency_contact', isset($patient) ? $patient->emergency_contact : '') }}">
                    </div>
                    <div class="field">
                        <label>Emergency Phone</label>
                        <input type="text" name="emergency_phone" value="{{ old('emergency_phone', isset($patient) ? $patient->emergency_phone : '') }}">
                    </div>
                </div>
            </div>
